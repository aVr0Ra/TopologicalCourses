...
constexpr auto qt_meta_stringdata_CLASSscheduleENDCLASS = QtMocHelpers::stringData(
    "schedule",
    "back",
    ""
);
...
void schedule::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &schedule::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
